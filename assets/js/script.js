...
$(".list-group").on("blur", "textarea", function() {
  ...
  var status = $(this)
  // grabbing the <ul> class name that the <li> items rest in (list-group)
    .closest(".list-group")
    // grabs the <ul> id created for the tasks created (list-ToDo)
    .attr("id")
    .replace("list-", "");
...
// editing tasks code ends

// code for editing due dates begins
